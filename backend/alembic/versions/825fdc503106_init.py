...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("reporter", "support", "admin", name="user_role_enum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("nowe", "przyjete", "zamkniete", name="ticket_status_enum"),
            nullable=False,
        ),
        ...
        sa.Column(
            "priority",
            sa.Enum(
                "niski", "sredni", "wysoki", "krytyczny", name="ticket_priority_enum"
            ),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_tickets_assigned_to_id"), "tickets", ["assigned_to_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_tickets_reporter_id"), "tickets", ["reporter_id"], unique=False
    )
